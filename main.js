...
const itihaText = document.getElementsByClassName('countdown-text');
const timeContainer = document.getElementsByClassName('time');
...
var updateCountdown = setInterval(function() {
    ...
    if (d > 0 || h > 0 || m > 0 || s > 0) {
        ...
        for (var i = 0; i < timeContainer.length; i++) {
            timeContainer[i].innerHTML = ""
        }
        console.log(itihaText)
        itihaText[0].children[0].innerHTML = "2022";
        itihaText[0].classList.add("countdown-end");
